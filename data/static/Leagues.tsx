...
export const LaLiga: League = League.create(
...
export const PremierLeague: League = League.create(
...
export const Allsvenskan: League = League.create(
...
export const ChampionsLeague: League = League.create(
...
export const LigatHaal: League = League.create(
